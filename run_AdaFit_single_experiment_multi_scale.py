...
LOGDIR = './log_multi_scale/my_experiments/'
...
os.system('CUDA_VISIBLE_DEVICES=0 python3 train_n_est_multi_scale.py --indir {} --name {} --points_per_patch {} --gpu_idx {} --batchSize {} --jet_order {} '
...
os.system('CUDA_VISIBLE_DEVICES=0 python3 test_n_est_multi_scale.py --testset {} --modelpostfix {} --logdir {} --gpu_idx {} --models {}'.format(
